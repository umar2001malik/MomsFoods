...
// import backgroundVideo from "../../assets/video7.webm";
...
import { useTranslation } from "react-i18next";
import backgroundVideo from "../../assets/video7.webm";
import bgImage from "../../assets/download.png"; // Add fallback image
...
const WhatMakesDifferent = () => {
  ...
  // SIMPLIFIED Animation Variants - FASTER
  const containerVariants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
  ...
  const listVariants = {
    ...
    show: {
      opacity: 1,
      transition: { 
        staggerChildren: 0.03, // Reduced from 0.06
  ...
  //     key={index}
  //     variants={itemVariants}
  //     className="flex items-start space-x-3 text-[#8B5E3C] p-1 md:p-3 rounded-xl cursor-pointer relative"
  //   >
  //     <motion.div
  //       variants={iconVariants}
  //       className="w-6 h-6 bg-gradient-to-br from-[#8B5E3C] to-[#D1A15D] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 shadow-lg 2xl:w-8 2xl:h-8"
  //     >
  //       <Icon className="w-3.5 h-3.5 text-white 2xl:w-5 2xl:h-5" />
  //     </motion.div>
      
  //     <span className="text-sm font-medium leading-relaxed 2xl:text-lg">
  //       {item}
  //     </span>
  //   </motion.div>
  // );
const AnimatedListItem = ({ item, index, icon: Icon, isGood = true }) => (
  ...
  >
    <motion.div
      variants={iconVariants}
      className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 shadow-lg 
                 bg-gradient-to-br from-[#3B2F2F] via-[#B88A44] to-[#F5D08C] 2xl:w-8 2xl:h-8"
    >
      {/* Icon stays white (or original color) */}
      <Icon className="w-3.5 h-3.5 text-white 2xl:w-5 2xl:h-5" />
    </motion.div>

    <span className="text-sm font-medium leading-relaxed 2xl:text-lg text-[#8B5E3C]">
      {item}
    </span>
  </motion.div>
);
      ...
      <div className="container max-w-[4000px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="h-1 bg-gradient-to-r from-[#EED7B5] via-[#8B5E3C] to-[#F8E7D3] rounded-full mx-auto mb-6 2xl:h-1.5 2xl:w-32"
          />
...
>
  {t('whatMakesDifferent.subtitle')}
        ...
        >
          ...
          <motion.div
            variants={columnVariants}
            className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50 relative 2xl:p-12"
          >
            <motion.h3 
            ...
            >
              {t('whatMakesDifferent.goodForYouTitle')}
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-0.5 bg-gradient-to-r from-[#8B5E3C] to-[#D1A15D] rounded-full 2xl:w-24 2xl:h-1" />
            </motion.h3>
            ...
            {translationsReady && (
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="grid md:grid-cols-2 gap-0 md:gap-4"
              >
                {goodForYou.map((item, index) => (
                  <AnimatedListItem 
                    key={index}
          ...
          >
            ...
            >
              {t('whatMakesDifferent.freeFromTitle')}
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-0.5 bg-gradient-to-r from-[#D1A15D] to-[#8B5E3C] rounded-full 2xl:w-24 2xl:h-1" />
            </motion.h3>
        ...
        <motion.div
          ...
          className="text-center mt-12 bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-green-200/50 max-w-2xl mx-auto 2xl:p-12 2xl:max-w-4xl"
        >
          <p className="text-[#8B5E3C] text-lg md:text-xl leading-relaxed 2xl:text-3xl">
            {t('whatMakesDifferent.footer.part1')}{" "}
