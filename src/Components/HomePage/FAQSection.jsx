...
// export default FAQSection;
  ...
  // import backgroundVideo from "../../assets/video9.webm";
...
import { useTranslation } from "react-i18next";
import backgroundVideo from "../../assets/video9.webm";
import bgImage from "../../assets/download1.png"; // Add fallback image
...
const FAQSection = () => {
  ...
  const faqItemVariants = {
    ...
    visible: (i) => ({
      ...
      transition: {
        ...
        delay: 0.1 + i * 0.05 // FASTER - reduced delay between items
      }
    })
  };
  ...
  const FAQItemIcon = ({ icon: Icon, isOpen, index }) => (
    <div
      className="w-10 h-10 lg:w-14 lg:h-14 2xl:w-16 2xl:h-16 rounded-full flex items-center justify-center mr-4 lg:mr-6 flex-shrink-0"
      style={{
        backgroundColor: isOpen 
          ? "rgba(139, 94, 60, 0.1)" 
          : "rgba(139, 94, 60, 0.05)",
      ...
      <div className="container max-w-[4000px] mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-20 pb-10">
        ...
        >
          ...
          >
            ...
            >
              {t('faq.title.line1')}{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8B5E3C] via-[#A67C52] to-[#D1A15D]">
                {t('faq.title.highlighted')}
              </span>
            </motion.h2>
          </motion.div>
          ...
          <motion.div
            ...
            className="h-1 lg:h-1.5 2xl:h-2 bg-gradient-to-r from-[#8B5E3C] to-[#D1A15D] rounded-full mx-auto mb-6 lg:mb-8"
          />
          ...
          <motion.p
            ...
            className="text-lg md:text-xl max-w-2xl mx-auto font-light 2xl:text-3xl 
             text-[#8B5E3C] bg-white/80 backdrop-blur-sm p-3 rounded-xl
          ...
          >
            {faqs.map((faq, index) => (
              <motion.div
                ...
                initial="hidden"
                whileInView="visible"
                className="bg-white/80 backdrop-blur-xl rounded-2xl lg:rounded-3xl 2xl:rounded-4xl shadow-lg border border-white/50 overflow-hidden cursor-pointer"
                onClick={() => toggleFAQ(index)}
              >
                {/* Question Button */}
                <motion.button
                  variants={questionButtonVariants}
                  animate={openIndex === index ? "open" : "initial"}
                  className="w-full text-left px-6 py-6 lg:px-8 lg:py-8 2xl:px-12 2xl:py-10 flex items-center focus:outline-none"
                >
                  {/* FAQ Item Icon */}
                  <FAQItemIcon 
                    icon={getIcon(faq.icon)} 
                  ...
                  <span className="text-xl lg:text-2xl 2xl:text-3xl font-semibold text-[#8B5E3C] font-serif pr-4 lg:pr-6 leading-relaxed lg:leading-loose 2xl:leading-loose flex-1 text-left">
                    {faq.question}
                  </span>
                  ...
                  <motion.div
                    variants={iconVariants}
                    animate={openIndex === index ? "open" : "initial"}
                    className="flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12 2xl:w-14 2xl:h-14 bg-gradient-to-br from-[#8B5E3C] to-[#D1A15D] rounded-full flex items-center justify-center shadow-lg"
                  >
                    <div style={{ opacity: openIndex === index ? 0 : 1 }}>
                      <Plus className="w-5 h-5 lg:w-6 lg:h-6 2xl:w-7 2xl:h-7 text-white" />
                    </div>
                    <div style={{ 
                ...
                <AnimatePresence>
                  {openIndex === index && (
                    <motion.div
                      ...
                      animate="animate"
                      exit="exit"
                      className="border-t border-[#EED7B5]/30"
                    >
                      <div className="px-6 pb-6 pt-4 lg:px-8 lg:pb-8 lg:pt-6 2xl:px-12 2xl:pb-10 2xl:pt-8">
                        <p className="text-[#6b4a2f] text-lg lg:text-xl 2xl:text-2xl leading-relaxed lg:leading-loose 2xl:leading-loose font-light bg-[#F8E7D3]/30 rounded-lg lg:rounded-xl 2xl:rounded-2xl p-4 lg:p-6 2xl:p-8 border border-[#EED7B5]/50">
                          {faq.answer}
                        </p>
                      </div>
                    </motion.div>
        ...
        <motion.div
          ...
          className="text-center mt-12 lg:mt-16 2xl:mt-20"
        >
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl lg:rounded-3xl 2xl:rounded-4xl p-8 lg:p-12 2xl:p-16 shadow-2xl border border-white/50 max-w-2xl lg:max-w-3xl 2xl:max-w-4xl mx-auto">
            <h3 className="text-2xl lg:text-3xl 2xl:text-4xl font-serif font-bold text-[#8B5E3C] mb-4 lg:mb-6">
              {t('faq.cta.title')}
            </h3>
            <p className="text-[#6b4a2f] text-lg lg:text-xl 2xl:text-2xl mb-6 lg:mb-8 leading-relaxed">
              {t('faq.cta.description')}
            </p>
            <motion.button
              variants={buttonVariants}
              whileHover="hover"
              onClick={handleContactClick}
              className="bg-gradient-to-r from-[#8B5E3C] to-[#D1A15D] text-white font-semibold py-3 px-8 lg:py-4 lg:px-10 2xl:py-5 2xl:px-12 rounded-xl lg:rounded-2xl shadow-lg text-lg lg:text-xl 2xl:text-2xl cursor-pointer"
            >
              {t('faq.cta.button')}
            </motion.button>
          </div>
